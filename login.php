...
<html lang="en">
  ...
  <div class="d-lg-flex half">
    <div class="bg order-1 order-md-2" style="background-image: url('public/images/login/login.jpg');background-size:contain;"></div>
          ...
          <div class="col-md-7">
            ...
            <form action="admin" method="post">
              <div class="form-group first">
                ...
                <input type="text" class="form-control" placeholder="thiam-Ngagne@gmail.com" id="Email">
              </div>
              ...
              <input type="submit" value="connexion" class="btn btn-block btn-primary " style="background-color:#3C027B">
